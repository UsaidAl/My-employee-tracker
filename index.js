  ...
  while (continueExecution) {
    ...
    switch (action) {
        ...
        case 'Remove an Employee':
            ...
            break;
            // Exit the application if the user selects 'Quit Application'
...
// Helper function to prompt the user to select a department
...
// Helper function to prompt the user to select a role
...
// Helper function to prompt the user to select an employee
